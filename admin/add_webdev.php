    ...
    <section class="section">
      ...
      <div class="card mx-auto" style="max-width: 620px;"> <!-- Centering the card -->
        <div class="card-body">
          ...
          <!-- Developer Form -->
          <form action="con_addwebgamedev.php" method="post" enctype="multipart/form-data">
            <div class="row mb-3">
              <label for="developerName" class="col-sm-2 col-form-label">Developer Name</label>
              <div class="col-sm-10">
                <input type="text" name="webdev_name" class="form-control" id="developerName" required> <!-- Changed -->
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input class="form-control" type="file" name="webdev_photo" id="devImage" accept="image/*" required>
              </div>
            </div>
            <div class="row mb-3">
              <label for="linkedinUrl" class="col-sm-2 col-form-label">LinkedIn URL</label>
              <div class="col-sm-10">
                <input type="url" name="linkdin_url" class="form-control" id="linkedinUrl" required>
              </div>
            </div>
            <div class="row mb-3">
              <label for="developerRole" class="col-sm-2 col-form-label">Game</label> <!-- नया लेबल -->
              <div class="col-sm-10">
                <input type="text" name="webdev_role" class="form-control" id="developerRole" required> <!-- नया इनपुट -->
              </div>
            </div>
            <!-- <div class="row mb-3">
