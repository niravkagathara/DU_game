        ...
        <section class="section">
            ...
            <div class="card mx-auto" style="max-width: 620px;"> <!-- Centering the card -->
                <div class="card-body">
                    ...
                    <!-- Developer Form -->
                    <form action="con_editgamedev.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" value="<?php echo $_GET['id']; ?>" name="id">
                        <input type="hidden" value="<?php echo $g['dev_photo'] ?>" name="photo">

                        <div class="row mb-3">
                            <label for="developerName" class="col-sm-2 col-form-label">Developer Name</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo $g['dev_name'] ?>" name="dev_name" class="form-control" id="developerName" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="phone_no" class="form-control" id="phone" value="<?php echo $g['phone_no']; ?>" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="devImage" class="col-sm-2 col-form-label">Developer Image</label>
                            <div class="col-sm-10">
                                <input class="form-control" value="<?php echo $g['dev_photo'] ?>" type="file" name="dev_photo" id="devImage" accept="image/*">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="linkedinUrl" class="col-sm-2 col-form-label">LinkedIn URL</label>
                            <div class="col-sm-10">
                                <input type="url" name="linkdin_url" class="form-control" id="linkedinUrl" value="<?php echo $g['linkdin_url']; ?>" >
                            </div>
                        </div>
                        <div class="row mb-3">
